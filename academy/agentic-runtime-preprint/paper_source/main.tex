...
\begin{table}[t]
\centering
\caption{Comparison of Harness responsibilities across production agent and workflow systems. Assessment based on public documentation and cited sources; rows marked \textsuperscript{†} denote concurrent work (July 2026) positioned in Section~4, and the row for this paper denotes design goals, not validated results.}
...
Skillware\textsuperscript{†} & yes & partial & no & no & yes \\
GRACE\textsuperscript{†} & yes & no & yes & no & partial \\
